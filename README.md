...
[![Release](https://img.shields.io/badge/Release-v1.0.7%20GA-2ea043)](./docs/releases/1.0.7.md)
...
| Self-host with EvoPilot | You want the API and Dashboard in one generated stack | `npx create-evopilot@1.0.9 self-host --dir evopilot-stack --init-env` |
