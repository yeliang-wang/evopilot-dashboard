...
[![Release](https://img.shields.io/badge/Release-v2.1.0%20GA-2ea043)](./docs/releases/2.1.0.md)
...
| Self-host with EvoPilot | You want the API and Dashboard in one generated stack | `npx create-evopilot@2.1.0 self-host --dir evopilot-stack --init-env` |
