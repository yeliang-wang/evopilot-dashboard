...
| Release readiness | Versioned release notes, changelog, release checklist, smoke validation, browser test matrix, visual regression, PR artifacts, cloud runbook artifact, and immutable artifact workflow. | `CHANGELOG.md`, `docs/releases/1.0.10.md`, `docs/operations/release-management.md`, `docs/operations/test-matrix.md` |
