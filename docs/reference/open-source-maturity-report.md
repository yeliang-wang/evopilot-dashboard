...
| Release readiness | Versioned release notes, changelog, release checklist, smoke validation, browser test matrix, visual regression, PR artifacts, cloud runbook artifact, and immutable artifact workflow. | `CHANGELOG.md`, `docs/releases/2.3.0.md`, `docs/operations/release-management.md`, `docs/operations/test-matrix.md` |
