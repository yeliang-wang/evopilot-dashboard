...
- [EvoPilot Dashboard v2.4.0 Release Notes](releases/2.4.0.md) is the EvoPilot v2.4 one-command Harness evolution compatibility body for the current public production baseline.
