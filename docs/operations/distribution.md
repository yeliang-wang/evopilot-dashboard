...
```bash
curl -fsSL https://raw.githubusercontent.com/yeliang-wang/evopilot-dashboard/v3.1.2/install.sh | bash -s -- --api-url http://127.0.0.1:19876 --harness-hub-url http://127.0.0.1:4176 --dir evopilot-dashboard-run
```
